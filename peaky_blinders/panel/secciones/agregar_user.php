...
<div class="container">
    <div class="row">
    <div class="col-12">
    <h1 class="center-block titulo contactotitulo">Nuevo Usuario</h1>
    </div>
    </div>
</div>
...
?>
            ...
            <div class="card-body">
<form action="acciones/agregar_user.php" method="POST">
                    <div class="row">
                    ...
                    <div class="form-group col-12">
                        <label class="text-white"for="permiso">Permiso*(admin,usuario)</label>
                        <input type="text cuadrotexto" class="form-control" name="permiso" id="permiso"
                            placeholder="Escribir admin o usuario">
                    </div>
